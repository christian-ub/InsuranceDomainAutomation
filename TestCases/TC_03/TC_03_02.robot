*** Settings ***
Documentation  TestCase TC_03_02: Count of Queensland clients
Resource    ../../Resources/TC_03_Scripts/TC_03_02_SQL.robot

*** Keywords ***
Set Variables
    TC_03_02_SQL.Set Variables

Retrieve Data
    TC_03_02_SQL.Count of Queensland clients
...
Verify Insert Contains Correct Retrieved Data
    run keyword and continue on failure    TC_03_02_SQL.Verify Last Input

Update Newly Inserted Data
    TC_03_02_SQL.Update Newly Inserted Data
