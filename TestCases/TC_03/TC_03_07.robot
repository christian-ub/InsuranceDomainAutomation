*** Settings ***
Documentation  TestCase TC_03_07: Count of Queensland clients with over 4 Units_Total
Resource    ../../Resources/TC_03_Scripts/TC_03_07_SQL.robot

*** Keywords ***
Set Variables
    TC_03_07_SQL.Set Variables

Retrieve Data
    TC_03_07_SQL.Count of Queensland clients with over 4 Units_Total
...
Verify Insert Contains Correct Retrieved Data
    run keyword and continue on failure    TC_03_07_SQL.Verify Last Input

Update Newly Inserted Data
    TC_03_07_SQL.Update Newly Inserted Data
