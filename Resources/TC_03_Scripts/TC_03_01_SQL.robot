*** Settings ***
Documentation   SQL scripts for TestCase TC_03_01: Total count of clients
...
Set Variables    # Manual insert of TestCase and Test_Columns
    set test variable    ${TestCase}    TC_03_01
    set test variable    ${Test_Column_1}    Result
    set test variable    ${TestStatus}    Pending

Total count of clients    # Manual insert of SQL query and handling of variables
    ${QueryResults} =  row count    select * from InsuranceDataDomain.dim_client
