*** Settings ***
Documentation   SQL scripts for TestCase TC_03_08: Check if any Units_Total are 0
...
Set Variables    # Manual insert of TestCase and Test_Columns
    set test variable    ${TestCase}    TC_03_08
    set test variable    ${Test_Column_1}    Result
    set test variable    ${TestStatus}    Pending

Check if any Units_Total are 0    # Manual insert of SQL query and handling of variables
    ${QueryResults} =  row count    select * from InsuranceDataDomain.fact_insurance_cover where Units_Total = 0
