*** Settings ***
Documentation   SQL scripts for TestCase TC_03_06: Count of all clients with over 4 Units_Total
...
Set Variables    # Manual insert of TestCase and Test_Columns
    set test variable    ${TestCase}    TC_03_06
    set test variable    ${Test_Column_1}    Result
    set test variable    ${TestStatus}    Pending

Count of all clients with over 4 Units_Total    # Manual insert of SQL query and handling of variables
    ${QueryResults} =  row count    select * from InsuranceDataDomain.fact_insurance_cover where Units_Total >=4
