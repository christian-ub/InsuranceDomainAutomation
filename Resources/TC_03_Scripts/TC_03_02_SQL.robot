*** Settings ***
Documentation   SQL scripts for TestCase TC_03_02: Count of Queensland clients
...
Set Variables    # Manual insert of TestCase and Test_Columns
    set test variable    ${TestCase}    TC_03_02
    set test variable    ${Test_Column_1}    Result
    set test variable    ${TestStatus}    Pending

Count of Queensland clients    # Manual insert of SQL query and handling of variables
    ${QueryResults} =  row count    select * from InsuranceDataDomain.dim_client where state = 'Queensland'
